...
if (isset($_GET["id_pembayaran"])) {
    ...
    $result = mysqli_query($mysqli, "SELECT * FROM pembayaran WHERE id_pembayaran='$id_pembayaran'");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = mysqli_query($mysqli, "UPDATE pembayaran SET NIS='$NIS', tgl_bayar='$tgl_bayar', jumlah_bayar='$jumlah_bayar' WHERE id_pembayaran='$id_pembayaran'");

    // Pastikan query berhasil dieksekusi
    if ($query) {
        echo '<script>alert("Berhasil memperbarui data"); window.location.href = "tabelpembayaran.php";</script>';
    } else {
        echo "Error: " . mysqli_error($mysqli);
    }
}
